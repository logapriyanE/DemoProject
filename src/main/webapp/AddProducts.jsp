...
<input type= "text" name ="bname" id="text" placeholder="name"  >
<label for ="last">Enter Categry </label>
<input type= "text" name ="cname" id="last" placeholder="last" >
<label for="text"> Enter Image url </label>
 <input type="text" name="url" id="num" step="">
<label for="text"> Enter Price</label>
<input type="text" name="pname" id="us" required>
